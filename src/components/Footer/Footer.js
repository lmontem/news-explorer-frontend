            ...
            <footer className='footer'>
                ...
                <nav className='footer__links'>
                    <ul className='footer__list'>
                        <li><a className='footer__link' href= '#' target='_blank' rel='noreferrer'>Home</a></li>
                        <li><a className='footer__link'href= 'https://practicum.yandex.com/' target='_blank' rel='noreferrer'>Practicum by Yandex</a></li>
