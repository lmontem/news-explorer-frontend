    ...
    return (
        (
            <nav className= 'nav'>
                ...
                <button onClick= {props.handleRegisterClick} className={` nav__btn nav__text nav__text_${props.savedNewsLocation ? 'black' : ''}`}>Sign in</button> {/*changes to user name when user is signed in */}
            </nav>
